...
<div class="publish-wrap">
    <div id="app" class="publish-card">
        ...
        <div class="publish-head">
            ...
            <p class="publish-sub">填写下面的信息，把您的闲置变成价值。所有带 <span style="color: var(--color-danger);">*</span> 的为必填项。</p>
        </div>
        ...
        <form action="<%=ctx%>/item?action=publish" method="post"
            ...
            <div class="section-block">
                <div class="section-head">
                    ...
                    <span class="section-tip">每行一个 URL，最多 5 张，第一行作为封面</span>
                </div>
            ...
            <div class="submit-bar">
                ...
                <a href="<%=ctx%>/item?action=list" class="btn-cancel">取消</a>
